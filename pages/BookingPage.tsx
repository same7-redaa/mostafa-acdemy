...
const BookingPage: React.FC<BookingPageProps> = ({ packageName = 'حصة تجريبية مجانية' }) => {
  ...
  const handleWhatsAppContact = () => {
    const message = encodeURIComponent(`السلام عليكم، أريد الاستفسار عن ${packageName}`);
      ...
      <div className="bg-gradient-to-br from-purple-600 to-purple-700 text-white py-6 shadow-xl">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">احجز الآن</h1>
